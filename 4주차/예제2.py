...
#
# 입력
# 첫째 줄에 점의 개수 nn이 주어진다. (1 \leq n \leq 100,0001≤n≤100,000) 두 번째 줄부터 각 점의 x좌표, y좌표가 주어진다. 이는 모두 정수이다.
#
# 출력
# 기울기의 절댓값의 최댓값을 소숫점 넷째자리에서 반올림하여 출력한다.
#
# 입력 예시
# 4
# 0 3
...
def maxSlope(points) :
    ...
    **주의** : 소숫점 넷째자리에서 반올림하는 것은 고려할 필요가 없습니다. 이는 main()에서 출력을 할 때에 처리가 되므로,
